...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("\nOriginal Centrifuge: " + centrifuge1.getManufacturer() + " " + centrifuge1.getModel());
        ...
        System.out.println("\nRetrieved Lab Equipment: " + retrievedLabEquipment.getManufacturer() + " " + retrievedLabEquipment.getModel());
